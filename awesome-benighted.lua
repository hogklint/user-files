...
awful.spawn.once("chromium --restore-last-session --unsafely-treat-insecure-origin-as-secure=http://chat01.asdf4.bcompany.net", { floating = false, screen = function() return screen.count() > 1 and 2 or 1 end, tag = "2" } )
awful.spawn.once("nm-applet", {} )
awful.spawn.once("urxvt -e tmuxifier load-session asdf42", { floating = false, maximized = true, screen = function() return screen.count() > 1 and 2 or 1 end, tag = "1" } )
awful.spawn.once("urxvt -e tmuxifier load-session asdf22", { floating = false, maximized = true, screen = function() return screen.count() > 1 and 2 or 1 end, tag = "1" } )
awful.spawn.once("mount /home/jimmieh/asdf4/aosp_local/out", {} )
awful.spawn.once("mount /home/jimmieh/asdf2/aosp_local/out", {} )
--awful.spawn.once("urxvt -e tmuxifier load-session asdf41", { floating = false, maximized = true, screen = 1, tag = "1" } )
--awful.spawn.once("urxvt -e tmuxifier load-session asdf21", { floating = false, maximized = true, screen = 2, tag = "1" } )
-- }}}
