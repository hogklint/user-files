...
awful.rules.rules = {
	...
	-- Set Firefox to always map on the tag named "2" on screen 1.
	{
		...
		properties = {
			floating = false,
			screen = function()
				return screen.count() > 1 and 2 or 1
			end,
			tag = "2",
		},
	},
...
awful.spawn.once("kitty tmuxp load -y 1", { floating = false, maximized = true, screen = 1, tag = "1" })
awful.spawn.once("kitty tmuxp load -y 0", {
	floating = false,
	maximized = true,
	screen = function()
		return screen.count() > 1 and 2 or 1
