...
docker run \
    ...
    -v $AOSP_HOME/vendor/acompany/one_update:/oneupdate/one_update \
    ...
    #/oneupdate/one_update/ciat/ciat_asdf4_update_one.py --flashfiles /oneupdate/flashfiles --config-file /oneupdate/nodes.config --config-unit $UNIT_NAME
