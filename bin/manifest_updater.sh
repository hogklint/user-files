...
P_MANIFESTS=(ASDF4_android-P-devel.xml ASDF4_android-P-devel-src.xml devel-p.xml components.xml bsp-dev-p.xml)
Q_MANIFESTS=(ASDF4_android-Q-devel.xml ASDF4_android-Q-devel-src.xml devel-q.xml components.xml bsp-dev-q.xml)
